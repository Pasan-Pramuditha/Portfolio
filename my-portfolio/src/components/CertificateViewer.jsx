...
const CertificateViewer = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] pt-28 pb-20 relative overflow-hidden flex flex-col">
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10 flex-grow flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start justify-center flex-grow w-full">
          {/* Left side: Image */}
          <motion.div 
            ...
            className="w-full lg:w-2/3 flex items-center justify-center bg-[#0a0a0a] rounded-3xl border border-white/5 p-4 md:p-6 overflow-hidden shadow-2xl transition-transform duration-500"
          >
            <img 
              src={cert.image} 
              alt={cert.title} 
          ...
          <motion.div 
            ...
            initial="hidden"
            animate="visible"
            className="w-full lg:w-1/3 bg-[var(--card-bg)] border border-[var(--card-border)] rounded-3xl p-8 flex flex-col relative overflow-hidden h-full min-h-[400px]"
          >
